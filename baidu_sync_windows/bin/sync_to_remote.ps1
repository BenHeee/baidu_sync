# Baidu Cloud Upload Sync Script
...
Write-Host "========================================"
Write-Host "    Baidu Cloud Sync Tool - Upload"
Write-Host "========================================"
Write-Host "Starting to sync local files to Baidu Cloud..."
